--LEER ANTES DE EJECUTAR EL SCRIPT

--PRIMERO SE DEBE CREAR LA BASE DE DATOS ANTES DE EJECUTAR TODO LO DEMAS!
CREATE DATABASE oriontek_oficial

--LUEGO DE HABER CREADO LA BASE DE DATOS SE EJECUTA TODO LO SIGUIENTE

USE oriontek_oficial
GO
...
--USUARIOS POR DEFECTO PARA ACCEDER AL SISTEMA

--USUARIO NORMAL

INSERT INTO usuarios (nombre, apellido, email, pass, acceso) VALUES('john','doe', 'johndoe@algo.com',123456, 0)

--USUARIO ADMIN

INSERT INTO usuarios (nombre, apellido, email, pass, acceso) VALUES('admin','admin', 'admin@algo.com',123456, 1)